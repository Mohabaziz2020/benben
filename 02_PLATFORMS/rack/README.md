...
> **Strategic SSOT | مصدر الحقيقة الاستراتيجي**  
> Full Vision, Mission & Agreements live in [[01_CONSTITUTION/PROJECT_BIBLE#Circuit Rack \| سيركيت راك]]. This file is a **navigation hub only**.

---

## Vision & Mission | الرؤية والمهمة

<!-- VISION MISSION SUMMARY — SSOT: PROJECT_BIBLE -->

| | EN | AR |
|---|----|-----|
| **Vision** | Trustworthy, searchable industrial commerce — regulated marketplace | تجارة صناعية موثوقة قابلة للبحث — سوق منضبط |
| **Mission** | Own product & commerce SSOT; buy·sell·guide; marketplace mechanics | امتلاك SSOT التجارة؛ شراء·بيع·دليل؛ آليات السوق |
...
<!-- AGREEMENTS SUMMARY — SSOT: PROJECT_BIBLE -->

**EN:** Rack-scoped consents only — account, seller, buyer, Boost, marketplace, wallet. No bundled Pro/Labs terms.

**AR:** موافقات راك فقط — حساب، بائع، مشتري، Boost، سوق، محفظة. بلا دمج شروط Pro/Labs.

**Full registry →** [[01_CONSTITUTION/PROJECT_BIBLE#Rack Key Agreements SSOT | راك — الاتفاقات (SSOT)]]
...
*Maestro · Rack MOC hub · strategic detail in [[01_CONSTITUTION/PROJECT_BIBLE]]*