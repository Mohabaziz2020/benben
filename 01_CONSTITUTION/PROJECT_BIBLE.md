...
18. [Revision History](#revision-history) · [Status](#status)
...
**Scope** — Legal artifacts are **per platform**. Parent policy internal. Cross-platform legal models require ADR.

**Per platform (where applicable)** — Privacy · account activation · listing/publication consents · compliance & prohibited content · refund/warranty/sale terms · IP · marketing · billing.

No cross-brand legal bundles.
